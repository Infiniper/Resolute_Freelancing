 ...
 * Milky-Way photo-sphere deepest, two star layers over it, and slow drifting
 * debris. It never unmounts, so moving between pages feels like one continuous
 * flight. Counts drop on mobile. (No constellations / aurora / nebulae / fog —
 * the soft additive nebula planes and the scene fog each read as a translucent
 * slab / haze across the hero with Bloom on; the Milky-Way wash + stars carry
 * the depth instead. The flying-saucer `Traveler` was pulled out too — to be
 * reused in a specific scene later; `src/3d/Traveler.jsx` stays in the tree.)
 */
